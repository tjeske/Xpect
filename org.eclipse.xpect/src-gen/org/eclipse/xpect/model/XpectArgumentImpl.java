 ...
 * @generated
 */
public class XpectArgumentImpl extends EObjectImpl implements XpectArgument
{
	/**
	...
	{
		return XpectPackage.Literals.XPECT_ARGUMENT;
	}
	...
	public void setIndex(int newIndex)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XpectPackage.XPECT_ARGUMENT__INDEX, oldIndex, index));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case XpectPackage.XPECT_ARGUMENT__INDEX:
				return getIndex();
		}
