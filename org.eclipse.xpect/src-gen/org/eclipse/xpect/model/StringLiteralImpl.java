...
public class StringLiteralImpl extends LiteralImpl implements StringLiteral
{
	...
	{
		return XpectPackage.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XpectPackage.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case XpectPackage.STRING_LITERAL__VALUE:
				return getValue();
		}
