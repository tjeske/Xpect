...
@Singleton
public class XpectGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class AssignmentElements extends AbstractParserRuleElementFinder {
		...
		//(declaredTarget=[types::JvmOperation|ID] "=" value=Value)
		public Group getGroup_0() { return cGroup_0; }
		
		//declaredTarget=[types::JvmOperation|ID]
		public Assignment getDeclaredTargetAssignment_0_0() { return cDeclaredTargetAssignment_0_0; }
		
		//[types::JvmOperation|ID]
